                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                      ...
                                      {images.map((url, index) => (
                                        <div key={index} className="relative group">
                                          <Image
                                            src={url.startsWith("http") || url.startsWith("/api/") ? url : `/api/images/${url}`}
                                            ...
                                            onError={(e) => {
                                              ...
                                              target.src = `data:image/svg+xml,<svg width="200" height="200" xmlns="http://www.w3.org/2000/svg"><rect width="200" height="200" fill="%23f3f4f6"/><text x="100" y="100" text-anchor="middle" font-family="Arial" font-size="12" fill="%236b7280">Image Error</text></svg>`;
                                            }}
                                          />
                                          {/* Edit Button */}
